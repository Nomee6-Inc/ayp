                        ...
                        <div class="row row-cards">
                          <div class="col-12">
                            <div class="card">
                              ...
                              ?>
                              <div class="card-body">
                                <h3 class="card-title">Dünya Ayarları 2</h3>
                            ...
                            <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herkesioldur" class="btn btn-primary">Herkesi Öldür</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herkesitekraryarat" class="btn btn-primary">Herkesi Tekrar Yarat</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="butundinlerisil" class="btn btn-primary">Bütün Dinleri Sil</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herkesmuslumanyab" class="btn btn-primary">Herkesi Müslüman Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herkeszenginyab" class="btn btn-primary">Herkesi Zengin Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herkesfakiryab" class="btn btn-primary">Herkesi Fakir Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="herulkeseriat" class="btn btn-primary">Her Ülkeye Şeriat Getir</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="kaoscikart" class="btn btn-primary">Ülkelerde KAOS Çıkart</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="icsavas" class="btn btn-primary">İç Savaş Başlat</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="ayikiyebol" class="btn btn-primary">Ayı ikiye böl</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="sukes" class="btn btn-primary">Dünyada ki suları kes</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="elektrikkes" class="btn btn-primary">Dünyada ki elektrikleri kes</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="vergidelete" class="btn btn-primary">Vergileri Sil</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="yanginucakdagit" class="btn btn-primary">Yangın Uçağı Dağıt</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="ormanyenile" class="btn btn-primary">Ormanları Yenile</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="butunkatilleroldur" class="btn btn-primary">Bütün Katilleri Öldür</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Ülke İsmi" required>
                                <div></div><h4></h4>
                                <button name="createulke" class="btn">Ülke Oluştur</button>
                                <button name="ulkesik" class="btn">Ülke Sil</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Din İsmi" required>
                                <div></div><h4></h4>
                                <button name="dinolustur" class="btn">Din Oluştur</button>
                                <button name="dinsik" class="btn">Din Sil</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Ayet Açıklaması" required>
                                <div></div><h4></h4>
                                <button name="dinolustur" class="btn">Ayet Ekle</button>
                                <button name="dinsik" class="btn">Ayet Sil</button>
                                <small class="form-hint">
                                    Not: Eğer Ayet Silmek istiyorsanız ayetin ID'sini girin.
                                </small>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                ...
                                <div></div><h4></h4>
                                <a href="kuran.php" class="btn btn-primary">Kuran Ayarları</a>
                                <div></div><h4></h4>
                                <a href="twitch.php" class="btn btn-primary">Twitch Ayarları</a>
                              </form>
                              <div></div><h4></h4>
                              <small class="form-hint">
