                          ...
                          <div class="col-12">
                            ...
                            <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Kıyamet Süresi" required>
                                <div></div><h4></h4>
                                <input type="text" class="form-control" placeholder="Kıyamet Gönderen Kullanıcı İsmi" required>
                                <div></div><h4></h4>
                                <button name="kiyametsend" class="btn btn-primary">Kıyamet Yolla</button>
                              </form>
                              <div></div><h4></h4>
                              Terör Örgütü Oluştur:
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Terör Örgütü İsmi" required>
                                <div></div><h4></h4>
                                <input type="text" class="form-control" placeholder="Örgüt Sloganı" required>
                                <div></div><h4></h4>
                                <input type="text" class="form-control" placeholder="Örgüt Lideri" required>
                                <div></div><h4></h4>
                                <button name="orgutolustur" class="btn btn-primary">Örgüt Oluştur</button>
                              </form>
                              <div></div><h4></h4>
                              Kuran Güncelle:
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                 Kuran Dosyasını rar şeklinde yükleyin.
                                <input type="file" class="form-control" placeholder="" required>
                                <div></div><h4></h4>
                                <input type="text" class="form-control" placeholder="Kuran Versiyonu" required>
                                <div></div><h4></h4>
                                <button name="kuranupdate" class="btn btn-primary">Kuranı Güncelle</button>
                              </form>
                              <div></div><h4></h4>
                              Virüs Gönder:
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Virüs İsmi" required>
                                <div></div><h4></h4>
                                <input type="text" class="form-control" placeholder="Ülke İsmi" required>
                                <div></div><h4></h4>
                                <button name="sendvirus" class="btn btn-primary">Virüs Gönder</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
