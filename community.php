          ...
          <div class="page-header d-print-none">
            <div class="row align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <a href="new_post.php" class="btn btn-primary d-none d-sm-inline-block">
    ...
    <div class="divide-y">
        <div id="posts">
                ...
                $(document).ready(function () {
                    $.getJSON(\"./posts.json\", 
                        function (data) {
                        var student = '<div class=\"col-8\">';
                        $.each(data, function (key, value) {
                            student += '<div class=\"row\">'
                            student += '<div class=\"col\">'
                            student += '<div class=\"text-truncate\">'
                            student += '<strong>'+value.name+'</strong><br> <strong>\"'+value.post+'\"</strong><br> postunu paylaştı.'
                            student += '</div>'
                            student += '<div class=\"text-muted\">'+value.date+'</div>'
                            student += '</div>'
                            student += '</div>'
                            student += '</div><br>'
                        });
