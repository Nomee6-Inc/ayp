<?php
$data = file_get_contents('./cennet.json');
$json_arr = json_decode($data, true);

$jsonitem = file_get_contents("./cennet.json");
...
if (isset($_POST['huriarttir'])) {
  foreach ($json_arr as $key => $value) {
    if ($value['id'] == "huri") {
        $json_arr[$key]['value'] = $findvalue("huri")+rand(100, 1000);
    }
}
file_put_contents('./cennet.json', json_encode($json_arr));
header("Refresh:0");
};
...
if (isset($_POST['hurioldur'])) {
    foreach ($json_arr as $key => $value) {
      if ($value['id'] == "huri") {
          $json_arr[$key]['value'] = 0;
      }
  }
file_put_contents('./cennet.json', json_encode($json_arr));
header("Refresh:0");
                    ...
                    <div class="row row-cards">
                      <div class="col-xl-6">
                        <div class="row row-cards">
                          <div class="col-12">
                            <div class="card">
                              <div class="card-img-top img-responsive img-responsive-16by9" style="background-image: url(./static/cennet.jpg)"></div>
                              <div class="card-body">
                                <h3 class="card-title">Cennet Ayarları</h3>
                                <p>
                                    Huri Sayısı: <div class="text-danger"><?php echo $findvalue("huri"); ?></div>
                              ...
                              <div class="card-footer">
                                ...
                                <button name="huriarttir" class="btn btn-primary">Hurileri Arttır</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                              ...
                              Huri Ayarları:
                                <div></div><h4></h4>
                                <form enctype="multipart/form-data" action="" method="POST">
                                <button name="huribakire" class="btn btn-primary">Hurileri Bakire Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="hurioldur" class="btn btn-primary">Hurileri Öldür</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="olgunhuri" class="btn btn-primary">Hurileri Olgun Yap</button>
                              </form>
                              <div></div><h4></h4>
                              Cennet Ayarları:
                                <div></div><h4></h4>
                                <form enctype="multipart/form-data" action="" method="POST">
                                <button name="itemspawner" class="btn btn-primary">Item Spawner Yarat</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="geceyab" class="btn btn-primary">Gece Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="gunduzyab" class="btn btn-primary">Gündüz Yap</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="hurioldur" class="btn btn-primary">Herkesi Öldür</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="yassifirla" class="btn btn-primary">Herkesin Yaşını Sıfırla</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="cennetrestart" class="btn btn-primary">Cenneti Yeniden Başlat</button>
                              </form>
                              <div></div><h4></h4>
                              <form enctype="multipart/form-data" action="" method="POST">
                                <button name="sarapic" class="btn btn-primary">Cennetten Şarap İç</button>
                              </form>
                              <div></div><h4></h4>
                              </div>
                            </div>
