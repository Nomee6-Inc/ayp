...
$jsonitem = file_get_contents("./doviz.json");
                    ...
                    <div class="row row-cards">
                      <div class="col-xl-6">
                        <div class="row row-cards">
                          <div class="col-12">
                            <div class="card">
                              <div class="card-img-top img-responsive img-responsive-16by9" style="background-image: url(./static/dolar.jpg)"></div>
                              <div class="card-body">
                                <h3 class="card-title">Banka Ayarları</h3>
                                <p>
                                    Faiz Oranı: <div class="text-success"><?php echo $findvalue("faiz"); ?>%</div>
                                </p>
                              </div>
                              ...
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Yeni Faiz Oranı" name="newfaizprice" id="newdolarprice" required>
                                <div></div><h4></h4>
                                <button name="submit" class="btn btn-primary">Faizi Güncelle</button>
                              </form>
                              <div></div><h4></h4>
                              İsim Girin:
                                <div></div><h4></h4>
