                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <form enctype="multipart/form-data" action="" method="POST">
                                <input type="text" class="form-control" placeholder="Doların Yeni Fiyatı" name="newdolarprice" id="newdolarprice" required>
                                <div></div><h4></h4>
                                <button name="submit" class="btn btn-primary">Doları Güncelle</button>
                              </form>
                              <div></div><h4></h4>
                              </div>
                            </div>
