...
if (isset($_POST['submit'])) {
    function fileWriteAppend(){
	    ...
	    'post'          =>     htmlentities($_POST['postdesc']),
        'date'          =>     htmlentities(date("H:i M/d/Y")),
		);
		$array_data[] = $extra;
...
if(file_exists('posts.json'))
{
     ...
     if(file_put_contents('posts.json', $final_data))
     {
          $message = "success";
     }
};
header("Refresh:1 url=community");
};
?>
  ...
  <body>
      ...
      <div class="page-wrapper">
        ...
        <form action="" method="POST">
			...
			<div class="mb-3">
				<textarea class="form-control" rows="6" type="text" placeholder="Post İçerii" name="postdesc" required></textarea>
            </div>
			<div class="mb-3">
				<button class="form-control" name="submit" class="btn">Paylaş</button>
			</div>
		</form>
